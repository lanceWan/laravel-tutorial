    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          @endif
          <form action="{{url('admin/permission')}}" method="post" class="form-horizontal form-label-left">
            {{csrf_field()}}
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="last-name" name="display_name" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
            <div class="form-group">
